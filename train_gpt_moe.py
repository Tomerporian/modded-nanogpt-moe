...
model = GPT(GPTConfig(
    ...
    fsq_load_balance=args.fsq_load_balance,
    maxvio_load_balance=args.maxvio_load_balance,
    maxviosq_load_balance=args.maxviosq_load_balance,
    minmaxvio_load_balance=args.minmaxvio_load_balance,
    totalvio_load_balance=args.totalvio_load_balance,
